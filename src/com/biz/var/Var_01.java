...
public class Var_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * int형과float형은 똑같이 4byte(32bit)크기의
		 * 기억공간을 차지하도록 설계가 되어 있는데
		 * float형은 int형보다 훨씬 큰 값을 저장할 수 있다.
		 * 
		...
		intNum1 = (int)fNum1 ; // float형 변수에 담긴 값을 int형 변수에 대입 
		
		/*
		 * 변수의 형변환
		 * int형 변수에 담긴 값을 float형에 담으려 하면
		 * 자동으로 소수점 이하의 값이 추가되어 flaot형으로 변환
		 * 
		 * float형 변수에 담긴 값을 int형에 담으려 하면
		 * 컴파일러는 개발자가 실수한 것으로 생각
		 * 그래서 문법 오류가 발생
		 * 만약 개발자가 float형에 담긴 값을 소수점 이하를 자르고
		 * int형에 담겠다라고 선언할 수 있는데 이런 상황을 강제 형변환이라고 한다.
		 * 
		 */
